const en = {
  ...
  home: {
    str1: "World’s Largest Online Poker Network",
    ...
    option1: {
      title1: "Blockchain licensing verification",
      title2: "Industry Leading Security",
      title3: "Secure Encryption",
      title4: "Soft Gaming Experience",
      title5: "Rich game play",
      title6: "Be the Top Player",
      title7: "Anti-Friendship Card Anti-Privilege",
      title8: "High Quality VIP Service",
      title9: "Real Playing Experience",
      content1:
        "Blockchain is truly random.Will be checks and verifies on the chain, and 3rd party certification.",
      content2:
        "Silicon Valley technology for the detection of bots and unfair play",
      content3:
        "All data transmission is encrypted using blockchain technology AES-256.",
      content4:
        "Free bonuses and the softest, largest pool of recreational players",
      content5:
        "More than 20 flexible settings of table parameters, as well as game play, satisfy all your table modes.",
      content6:
        "Many world's top poker players and star players compete online, to participate in and learn in person.",
      content7:
        "Online identity verification, background data AI analysis to identify players.",
      content8: "To upgrade your VIP level,enjoy more exclusive service.",
      content9:
        "The game follows the standard rules of professional Texas Hold'em.Classic and professional.",
    },
    str4: "Impartial and security",
    str5: "Blockchain Technology Licensing able to retrospective inspection Unbreakable AES Military-Grade encryption",
    str6: "Optimized for Fairness",
  ...
  qrcode: {
    ...
    content: "Scan the QR Code, you will be redirected to the application download page.",
  }
};
